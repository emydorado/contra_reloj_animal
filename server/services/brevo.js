...
const sendWinnerEmailWithTemplate = async () => {
	try {
...
const sendLoserEmailWithTemplate = async () => {
	try {
		// Consulta Supabase para obtener el correo electrónico del usuario
		const { data, error } = await supabase
			.from('Registrations') // Reemplaza con el nombre de tu tabla
...
module.exports = { sendLoserEmailWithTemplate, sendWinnerEmailWithTemplate };
